...
// import { snacksList } from '.././assets/mockdata/snacks-recipe-mockdata';
...
export class BackendMockService {
  ...
  getSnacksList() {
    //return this.http.get<any>(this.snacksList);
  }
}
